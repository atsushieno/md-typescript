...
namespace MonoDevelop.TypeScriptBinding.Tools
{
	...
	static class TscCommandLineToolsManager
	{
		...
		public static BuildResult Compile (NMEProject project, NMEProjectConfiguration configuration, IProgressMonitor monitor)
		{
			...
			string error = "";
			int exitCode = DoCompilation ("TypeScriptlib", args, project.BaseDirectory, monitor, ref error);
