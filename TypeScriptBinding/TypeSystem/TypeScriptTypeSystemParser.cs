...
{
	public class TypeScriptTypeSystemParser : AbstractTypeSystemParser
	{
		...
		{
			// FIXME: provide compiler options.
			var parser = new TypeScriptParser (language_service, GetCompilerArguments (project));
			...
			// FIXME: if we need to deal with comments, implement required stuff.
			/*
